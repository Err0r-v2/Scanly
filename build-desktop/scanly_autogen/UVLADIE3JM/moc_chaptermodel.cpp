...
template <> constexpr inline auto ChapterModel::qt_create_metaobjectdata<qt_meta_tag_ZN12ChapterModelE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Method 'setPages'
        QtMocHelpers::MethodData<void(const QString &, const QString &, const QStringList &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
    ...
    return QtMocHelpers::metaObjectData<ChapterModel, qt_meta_tag_ZN12ChapterModelE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject ChapterModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QAbstractListModel::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12ChapterModelE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12ChapterModelE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN12ChapterModelE_t>.metaTypes,
    nullptr
} };
...
void *ChapterModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12ChapterModelE_t>.strings))
