...
template <> constexpr inline auto ImageCache::qt_create_metaobjectdata<qt_meta_tag_ZN10ImageCacheE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Method 'sizeOnDisk'
        QtMocHelpers::MethodData<qint64() const>(1, 2, QMC::AccessPublic, QMetaType::LongLong),
        // Method 'clear'
    ...
    return QtMocHelpers::metaObjectData<ImageCache, qt_meta_tag_ZN10ImageCacheE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject ImageCache::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10ImageCacheE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10ImageCacheE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10ImageCacheE_t>.metaTypes,
    nullptr
} };
...
void *ImageCache::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10ImageCacheE_t>.strings))
