...
static constexpr auto qt_meta_stringdata_ZN11SearchModelE = QtMocHelpers::stringData(
    "SearchModel",
    "updateFrom",
    "",
    "results"
...
Q_CONSTINIT static const uint qt_meta_data_ZN11SearchModelE[] = {
...
Q_CONSTINIT const QMetaObject SearchModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11SearchModelE.offsetsAndSizes,
    qt_meta_data_ZN11SearchModelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11SearchModelE_t,
        // Q_OBJECT / Q_GADGET
...
void SearchModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->updateFrom((*reinterpret_cast< std::add_pointer_t<QJsonArray>>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *SearchModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11SearchModelE.stringdata0))
