...
static constexpr auto qt_meta_stringdata_ZN14PageImageCacheE = QtMocHelpers::stringData(
    "PageImageCache",
    "changed",
    "",
    "prepare",
...
Q_CONSTINIT static const uint qt_meta_data_ZN14PageImageCacheE[] = {
...
Q_CONSTINIT const QMetaObject PageImageCache::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14PageImageCacheE.offsetsAndSizes,
    qt_meta_data_ZN14PageImageCacheE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14PageImageCacheE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<PageImageCache, std::true_type>,
        // method 'changed'
...
void PageImageCache::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (PageImageCache::*)();
            if (_q_method_type _q_method = &PageImageCache::changed; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *PageImageCache::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14PageImageCacheE.stringdata0))
