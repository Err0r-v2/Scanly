...
static constexpr auto qt_meta_stringdata_ZN15MangaMetaSourceE = QtMocHelpers::stringData(
    "MangaMetaSource",
    "metadataReceived",
    "",
    "mangaId",
...
Q_CONSTINIT static const uint qt_meta_data_ZN15MangaMetaSourceE[] = {
 ...
 // methods: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       6,    1,   46,    2, 0x102,    6 /* Public | MethodIsConst  */,
...
Q_CONSTINIT const QMetaObject MangaMetaSource::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15MangaMetaSourceE.offsetsAndSizes,
    qt_meta_data_ZN15MangaMetaSourceE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15MangaMetaSourceE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MangaMetaSource, std::true_type>,
...
void MangaMetaSource::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (MangaMetaSource::*)(const QString & );
            if (_q_method_type _q_method = &MangaMetaSource::metadataReceived; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *MangaMetaSource::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15MangaMetaSourceE.stringdata0))
